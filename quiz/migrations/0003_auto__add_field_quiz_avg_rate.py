...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.avg_rate'
        db.add_column(u'quiz_quiz', 'avg_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=5),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Quiz.avg_rate'
        db.delete_column(u'quiz_quiz', 'avg_rate')
    ...
    models = {
        ...
        u'quiz.quiz': {
            ...
            'avg_rate': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '5'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
